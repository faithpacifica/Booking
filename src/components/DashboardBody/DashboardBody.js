  ...
  return (
    <div className="dashboard-content">
      <div className="dashboard-content-inner">
        <h2 className="dashboard-content-heading">
          Hello, <span>Tom! </span>
        </h2>
        ...
        <div class="row center-row">
          <div className="activities-and-invoices">
            <div class="col-lg-6 col-md-12">
              <div class="dashboard-list-box with-icons margin-top-20">
                ...
                <ul>
                  ...
                  <li>
                    <i class="list-box-icon sl sl-icon-star"></i> Kathy Brown
                    left a review{" "}
                  ...
                  <li>
                    <i class="list-box-icon sl sl-icon-star"></i> Kathy Brown
                    left a review{" "}
                    <div class="numerical-rating mid" data-rating="3.0"></div>{" "}
                    on{" "}
                    <strong>
                      <a href="#">Airport</a>
                    </strong>
                  ...
                  <li>
                    <i class="list-box-icon sl sl-icon-star"></i> John Doe left
                    a review{" "}
                    <div class="numerical-rating high" data-rating="4.0"></div>{" "}
                    on{" "}
                    <strong>
                      <a href="#">Burger House</a>
                    </strong>
                  ...
                  <li>
                    <i class="list-box-icon sl sl-icon-star"></i> Jack Perry
                    left a review{" "}
                    <div class="numerical-rating low" data-rating="2.5"></div>{" "}
                    on{" "}
                    <strong>
